        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryStatesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_CountryStatesDb_CountryStatesId",
                        column: x => x.CountryStatesId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "6087ee19-aa49-4c21-8365-df83dd0aa943", "aa5f6397-b2b2-42e3-a5d4-37f30b9d6cf6", "Patient", "PATIENT" });

            migrationBuilder.InsertData(
                table: "IdentityRole",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "815dc5dc-dbf8-4c0c-8adb-c3cc16680221", "5cc17421-d4cc-4733-acc6-945366fb15f2", "Dietetician", "DIETETICIAN" });

            migrationBuilder.InsertData(
                table: "IdentityRole",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "adf4132e-400b-473a-b260-2174c1bbff1f", "9a1acebf-893d-44bd-8f2c-6ba6b9288ec6", "Admin", "ADMIN" });

            migrationBuilder.CreateIndex(
                name: "IX_Address_CountryStatesId",
                table: "Address",
                column: "CountryStatesId");
