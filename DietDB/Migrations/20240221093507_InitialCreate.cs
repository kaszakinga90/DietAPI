    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietPatient", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isContainHeader = table.Column<bool>(type: "bit", nullable: false),
                    isContainFooter = table.Column<bool>(type: "bit", nullable: false),
                    isActive = table.Column<bool>(type: "bit", nullable: false),
                    dateAdded = table.Column<DateTime>(type: "datetime2", nullable: false),
                    dateUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dateDeleted = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrlReportTemplate1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UrlReportTemplate2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UrlReportTemplate3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UrlReportTemplate4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    isActive = table.Column<bool>(type: "bit", nullable: false),
                    dateAdded = table.Column<DateTime>(type: "datetime2", nullable: false),
                    dateUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dateDeleted = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportTemplatePreview", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_CountryStatesDb_CountryStateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietSalesBill", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietSalesBill_Sales_SalesId",
                        column: x => x.SalesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitation_Users_DieticianId",
                        column: x => x.DieticianId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invitation_Users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminSended = table.Column<bool>(type: "bit", nullable: false),
                    PatientSended = table.Column<bool>(type: "bit", nullable: false),
                    DieticianSended = table.Column<bool>(type: "bit", nullable: false),
                    isActive = table.Column<bool>(type: "bit", nullable: false),
                    dateAdded = table.Column<DateTime>(type: "datetime2", nullable: false),
                    dateUpdated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dateDeleted = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DieticianPatientRatings", x => new { x.DieticianId, x.PatientId });
                    table.ForeignKey(
                        name: "FK_DieticianPatientRatings_Rating_RatingId",
                        column: x => x.RatingId,
                        principalTable: "Rating",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DieticianPatientRatings_Users_DieticianId",
                        column: x => x.DieticianId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DieticianPatientRatings_Users_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "21780d05-c4f4-43e0-9bb9-e29843ab5bb2", "07f3d69a-4c98-4448-b022-015cb904e158", "Admin", "ADMIN" },
                    { "3dddcb28-52e5-451f-b4e6-a326afd811ce", "c5dd4e2a-6923-429e-81c2-900df35a5dd1", "SuperAdmin", "SUPERADMIN" },
                    { "5c6aa8c3-5b64-4d76-933e-74617722de3b", "8362cec7-3138-4d73-8b87-21a70845763b", "Dietetician", "DIETETICIAN" },
                    { "90ef5982-e387-4615-9b4e-f2cfc5283b21", "a7581eb3-6df9-4896-8d1b-3727ed435b10", "Patient", "PATIENT" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DieticianPatientRatings_PatientId",
                table: "DieticianPatientRatings",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_DieticianPatientRatings_RatingId",
                table: "DieticianPatientRatings",
                column: "RatingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitation_DieticianId",
                table: "Invitation",
                column: "DieticianId");

            migrationBuilder.CreateIndex(
                name: "IX_Invitation_PatientId",
                table: "Invitation",
                column: "PatientId");
